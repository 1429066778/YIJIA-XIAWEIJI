...
//Demo for TFT LCD Shield 2.8" ILI9341 
//by Open-Smart Team and Catalex Team
//catalex_inc@163.com
//Store:   http://dx.com
//Demo Function: Before you paint it, you can select the color.
...
// Note that this 4 values should be calibrated if the volatage of the Atmega328P changed.
// As the backlight cost 150mA, maybe the voltage will drop from 5V to 4.6V.
#endif
